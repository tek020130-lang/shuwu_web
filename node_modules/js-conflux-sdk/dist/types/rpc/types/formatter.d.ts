...
declare namespace cfxFormat {
    export { getLogs, getLogsAdvance, AccessListEntry, transactionToAddress, signTx, sign1559Tx, callTx, callTxAdvance, status, estimate, transaction, block, receipt, epochReceipts, log, logs, supplyInfo, sponsorInfo, rewardInfo, voteList, depositList, head, revert, epoch, accountPendingInfo, accountPendingTransactions, posEconomics, voteParamsInfo, collateralInfo, wrapTransaction, feeHistory, LogFilter, CallRequest, ChainStatus, EstimateResult, Transaction, Block, TransactionReceipt, Log, SupplyInfo, SponsorInfo, RewardInfo, Vote, Deposit, BlockHead, RevertNotification, epochNumber, AccountPendingInfo, AccountPendingTransactions, PoSEconomics, VoteParamsInfo, CollateralInfo, FeeHistory };
}
declare var getLogs: any;
declare function getLogsAdvance(networkId: any, toHexAddress?: boolean, useVerboseAddress?: boolean): any;
declare var AccessListEntry: any;
declare var transactionToAddress: any;
declare var signTx: any;
declare var sign1559Tx: any;
...
declare var wrapTransaction: any;
declare var feeHistory: any;
type LogFilter = {
    /**
...
type Transaction = {
    /**
     * - the type of the transaction. 0 for legacy transaction, 1 for 2930 transaction, 2 for EIP-1559 transaction.
     */
    type: number;
    /**
    ...
    gasPrice: number;
    /**
     * - the maxPriorityFeePerGas specified by the sender.
     */
    maxPriorityFeePerGas: number;
    /**
     * - the maxFeePerGas specified by the sender.
     */
    maxFeePerGas: number;
    /**
...
type TransactionReceipt = {
    ...
    /**
     * - the burnt gas fee of the transaction.
     */
    burntGasFee: number;
    /**
...
type FeeHistory = {
    /**
     * Lowest epoch number of returned range.
     */
    oldestEpoch: BigInt;
    /**
     * An array of block gas used ratios. These are calculated as the ratio of tx gasLimit sum and block gasLimit.
     */
    gasUsedRatio: number[];
    /**
